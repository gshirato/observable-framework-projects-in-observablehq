...
export default class SmallMultiplesChart extends GeneralChart {
    ...
    hasIncorrectEndPos(d) {
      if (d.type.name === 'Shot') return true;
    ...
    mouseover(thisClass, event, d) {
      ...
      //     .join('tr')
      //     .selectAll('td')
      //     .data((d, i) => [i, d.match_period, sec2mmss(d.event_sec), d.type.name, d.sub_type.name, d.player_name, d.team.name, d.location[0], d.location[1], d.end_x, d.end_y])
      //     .join('td')
      //     .text(d => d);
